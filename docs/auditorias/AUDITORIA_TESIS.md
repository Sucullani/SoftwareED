...
**Última sesión**: 6 · 2026-09-16 · commit de la tesis auditado: `bdbf18d` (2026-09-11; sin
commits posteriores en `tesis/`, comprobado de nuevo en la sesión 6 contra `origin/main`).
**Los seis bloques están auditados**: la siguiente sesión solo reaudita si
`git log bdbf18d..HEAD -- tesis/` deja de estar vacío (y entonces, solo lo que cambió) o si
el Reglamento de Graduación aparece en `tesis/normas/` (H-1). Mientras eso no ocurra, cada
sesión programada termina sin hallazgos nuevos y solo deja su fila en el registro.
