...
**Capítulos (compartidos)**: (educativo) Mapa del cálculo → ① Planteo (hipótesis TP/DP + D) → ② Discretización → ③ Calidad → ④ Formulación elemental → ⑤ Ensamblaje → ⑥ Condiciones de contorno y solución (fusionados) → ⑦ Post-proceso → Glosario. En `'directo'` se omiten intro/mapa, resumen visual decorativo y glosario (gateados tras `_prose`); todo lo demás es idéntico, sin prosa.
