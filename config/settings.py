...
EDU_NODE_INDEX_FG_COLOR   = "#000000"   # Numero del nodo escrito DENTRO de su marcador en el cuadrado natural de M1 (negro sobre el naranja/azul/violeta del disco: es el unico tono legible sobre los tres). Antes literal "black" en mod01_iso_mapping._draw_natural.
...
CANVAS_COLORBAR_TEXT_COLOR       = "#ffffff"   # Color del titulo y de los rotulos numericos de la colorbar del canvas (blanco sobre el fondo oscuro). Antes literal "white" en mesh_canvas._draw_colorbar.
CANVAS_ISOLINE_COLOR             = "#ffffff"   # Color de las curvas de nivel (isolineas) sobre el campo de resultados. Blanco: es el unico tono que contrasta con TODO el arcoiris jet (azul, verde, amarillo, rojo). Antes literal "white" en mesh_canvas._draw_isolines.
# -- SURFACE_3D --
