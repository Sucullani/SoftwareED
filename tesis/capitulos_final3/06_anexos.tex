...
Intercambio de datos (criterio de la cláusula (a)): ida y vuelta CSV/ZIP del ejemplo canónico sin pérdida de entidades y con desplazamientos idénticos; importación del DXF de ejemplo (seis cuadriláteros y doce nodos, con los vértices comunes compartidos; orientación antihoraria) e idempotencia de la reimportación. &
