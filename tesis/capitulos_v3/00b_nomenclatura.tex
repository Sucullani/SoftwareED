...
vector de tracciones, y $E$ el módulo de elasticidad mientras $\bm{E}$ es la matriz de
extrapolación de tensiones.
...
ICAP & Marco de compromiso cognitivo en cuatro modos: interactivo, constructivo, activo y pasivo (\emph{interactive, constructive, active, passive}) \\
LORI & Instrumento de revisión de objetos de aprendizaje (\emph{Learning Object Review Instrument}), de nueve dimensiones \\
PI & Pregunta de investigación (PI-1 a PI-4) \\
\end{longtable}
