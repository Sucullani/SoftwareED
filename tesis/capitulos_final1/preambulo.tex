% PREAMBULO DE LA VERSION FINAL 1 (copia de tesis/preambulo.tex, 2026-09-23).
...
% --- Figuras y tablas ---
\usepackage{graphicx}
\graphicspath{{capitulos_final1/figuras/}{figuras/}}   % final1: las figuras rehechas tienen prioridad
\usepackage{booktabs}
\usepackage{array}
...
\hypersetup{
  ...
  pdfkeywords={método de elementos finitos, software educativo, elementos isoparamétricos Q4/Q9, elasticidad plana, verificación y validación, memoria de cálculo},
...
\addbibresource{capitulos_final1/referencias.bib}   % final1: copia propia de la bibliografia
