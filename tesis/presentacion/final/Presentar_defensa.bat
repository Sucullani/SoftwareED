@echo off
rem =====================================================================
rem  Abre la presentacion interactiva de la defensa en una ventana propia,
...
rem  orador, T tema claro/oscuro, F pantalla completa, ? ayuda.
rem =====================================================================
setlocal EnableDelayedExpansion
set "PAG=%~dp0Defensa_EduFEM.html"
set "URL=file:///!PAG:\=/!"
set "URL=!URL: =%%20!"
