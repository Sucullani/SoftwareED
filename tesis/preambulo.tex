...
% Separador entre las citas de un \autocites: punto y coma, no coma. Con
% localizadores de pagina la coma es ambigua ([6, p. 75, 23, p. 7] se lee como
% una lista de cuatro numeros); el punto y coma separa las dos referencias.
