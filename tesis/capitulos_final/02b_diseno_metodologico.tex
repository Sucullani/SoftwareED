...
Los criterios numéricos de aceptación están escritos en los propios guiones de verificación y validación, que los evalúan automáticamente y terminan con error si alguno falla. Los de trazabilidad son documentales, y los verifica el autor sobre la versión evaluada con la regla de marcado de la \autoref{sec:validacion-datos}. Unos y otros quedaron fijados antes de las corridas que este documento reporta. La \autoref{tab:criterios} los reúne, con la procedencia de cada umbral y con el resultado que lo refutaría.
...
Viga de Timoshenko & Error de $\sigma_x$ frente a la solución analítica, y diferencia frente a SAP2000, en tres puntos de control & $< 1\,\%$ & Tolerancia de ingeniería fijada por el autor & Un valor mayor \\
