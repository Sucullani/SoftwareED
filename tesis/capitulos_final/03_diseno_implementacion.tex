...
Los umbrales de calidad geométrica con que el comprobador de salud, la memoria de cálculo y el módulo M0 clasifican los elementos son convención de la herramienta, apoyada en los mínimos que la biblioteca Verdict fija para el cuadrilátero (\autoref{sec:calidad-malla}). Sobre esos mínimos, el corte del Jacobiano escalado se eleva de $0{,}30$ a $q_{SJ} \ge 0{,}50$ —el valor que Verdict fija para el triángulo y el hexaedro— por prudencia: en un curso introductorio conviene señalar como inadmisible un elemento que la biblioteca todavía toleraría. El módulo M0, por su parte, distingue como «buenos» los elementos con $q_{SJ} \ge 0{,}80$ y compacidad $q_C \ge 0{,}50$. El estado global de cada elemento —bueno, aceptable o malo— combina cuatro índices, que la \autoref{tab:umbrales} enumera con su significado y sus dos cortes.
