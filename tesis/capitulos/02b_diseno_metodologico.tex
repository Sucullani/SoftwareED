...
\midrule
Implementar el motor MEF 2D Q4/Q9 verificado & PI-1 & Tipo de elemento; exactitud (normas $L^2$, $H^1$) & Implementación pura en NumPy/SciPy; pruebas de regresión & \autoref{cap:diseno}; \autoref{cap:resultados} (MMS) \\
Diseñar la interfaz pre/proceso/post & PI-2 & Organización de la interfaz; flujo de trabajo & Diseño centrado en un lienzo único compartido & \autoref{cap:diseno} \\
Desarrollar los módulos educativos & PI-2 & Cobertura del canal de cálculo & Capas interactivas superpuestas a la malla real & \autoref{cap:diseno}; \autoref{cap:resultados} \\
...
Generar memoria de cálculo e interoperabilidad & --- & Trazabilidad del cálculo & Generación de PDF; importación/exportación DXF y CSV & \autoref{cap:diseno} \\
\bottomrule
\end{tabular}}
...
\section{Proceso metodológico de la investigación}
...
\section{Sistema de validación de los datos}
